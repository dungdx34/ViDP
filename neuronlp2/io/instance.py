...
class DependencyElmoInstance(object):
    def __init__(self, sentence, postags, pos_ids, heads, types, type_ids, elmo_ids):
        self.sentence = sentence
        self.postags = postags
        self.pos_ids = pos_ids
        self.heads = heads
        self.types = types
        self.type_ids = type_ids
        self.elmo_ids = elmo_ids

    def length(self):
        return self.sentence.length()

class DependencyBertInstance(object):
    def __init__(self, sentence, postags, pos_ids, heads, types, type_ids, bert_ids):
        self.sentence = sentence
        self.postags = postags
        self.pos_ids = pos_ids
        self.heads = heads
...
class DependencyElmoBertInstance(object):
    def __init__(self, sentence, postags, pos_ids, heads, types, type_ids, elmo_ids, bert_ids):
        self.sentence = sentence
        self.postags = postags
        self.pos_ids = pos_ids
        self.heads = heads
