...
def train():
  ...
  cmd.add_argument('--train_path', default='data/test.txt', required=False, help='The path to the training file.')
  ...
  cmd.add_argument('--config_path', default='configs/cnn_50_100_512_4096_sample.json', required=False, help='the path to the config file.')
  cmd.add_argument("--word_embedding", help="The path to word vectors.")

  cmd.add_argument('--optimizer', default='adam', choices=['sgd', 'adam', 'adagrad'],
  ...
  cmd.add_argument("--model", default='output/en', required=False, help="path to save model")
  ...
  cmd.add_argument('--min_count', type=int, default=3, help='minimum word count.')
